...
function preguntas(){
	...
	if (x < 10) {
		...
		$('section.prueba').append('<p class="texto animated bounceInRight">' + b.preguntas[c].textoEnunciado + '</p><p class="texto animated bounceInRight"><img class="imagen" src=img/' + b.preguntas[c].imagenCorrecta + '>' + b.preguntas[c].correcta + '<img class="imagen" src=img/' + b.preguntas[c].imagenIncorrecta + '>' + b.preguntas[c].incorrecta +'</p>');
		$('img.imagen').one('click', function(event){
			event.stopImmediatePropagation();
			setTimeout(function(){
			...
			if ($(this).attr('src') == 'img/' + b.preguntas[c].imagenCorrecta) {
				...
				setTimeout(function(){
					$('p.texto').addClass('animated bounceOutLeft');
				}, 500);
				setTimeout(function(){
					$('p.texto').addClass('hidden');
					preguntas();
				}, 500);
			}else{
