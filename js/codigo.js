...
function preguntas(){
	...
	$('div.padre').append('<p>' + b.preguntas[c].textoEnunciado + '</p><img src="img/Geografía"' + b.preguntas[c].imagenCorrecta + '<img src="img/Geografía"' + b.preguntas[c].imagenIncorrecta)
